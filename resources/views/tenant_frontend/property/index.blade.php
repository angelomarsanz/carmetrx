                                                ...
                                                @if ($basicInfo->property_country_status == 1)
                                                    <div class="form-group mb-20">
                                                        ...
                                                        <select name="country" id=""
                                                            ...
                                                            <option value="all" data-id="0" selected>
                                                                {{ $keywords['All'] ?? __('All') }}
                                                            </option>
                                                            @foreach ($all_countries as $country)
                                                                <option data-id="{{ $country->id }}"
                                                                    @selected(!empty(request('country')) && request('country') == $country->countryContent?->slug)
                                                    ...
                                                    <div class="price-value">
                                                        <span
                                                            ...
                                                            <span data-range-value="priceSliderValue">
                                                                {{ propertySymbol($min,$basicInfo->base_currency_symbol) }}
                                                                -
                                                                {{ propertySymbol($max,$basicInfo->base_currency_symbol) }}
                                                            </span></span>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="col-xl-9">
                    ...
                    <div class="row properties">
                        @forelse ($property_contents as $property_content)
                            <x-tenant.frontend.property :property="$property_content" :adminLang="$adminLang" :animate="false"
