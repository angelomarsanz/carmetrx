        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ajaxForm" class="modal-form create"
                    action="{{ route('admin.property_management.store_category') }}" method="post"
                    enctype="multipart/form-data">
                    @csrf

                    <div class="form-group">
                        <label for="">{{ __('Image') }} <span class="text-danger">{{ '*' }}</span>
                        </label>
                        <br>
                    ...
                    <div class="form-group">
                        ...
                        <select name="type" class="form-control">
                            ...
                            <option value="autos_camionetas">Autos y Camionetas</option>
                    ...
                    <div class="form-group">
                        <label for="">{{ __('Status') }} <span class="text-danger">{{ '*' }}</span>
                        </label>
