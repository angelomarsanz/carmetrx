...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ __('Edit Car') }}
                    @if (request('type') == 'autos_camionetas')
                        {{ __('Autos y Camionetas') }}
                    @else
                        {{ __('Camiones') }}
                    @endif
                </a>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select name="currency_symbol" class="form-control">
                                                ...
                                                <option value="U$D" @selected($property->currency_symbol == 'UY$')>
                                                    U$D
                                                </option>
                                            </select>
                                        </div>
...
@section('script')
    ...
    @if ($userBs->google_map_api_status == 1)
        <script>
            var defaultLang = "{{ $language->is_default == 1 ? $language->code : '' }}";
            var address = "{{ @$peopertyContent->address }}"
        </script>
